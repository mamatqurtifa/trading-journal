  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-6 py-8 max-w-4xl space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="bg-white border-gray-200 shadow-sm">
            <CardHeader className="pb-3">
              ...
              <CardTitle className="text-3xl text-gray-900">{profile.stats.totalTrades}</CardTitle>
            </CardHeader>
          </Card>
          ...
          <Card className="bg-white border-gray-200 shadow-sm">
            <CardHeader className="pb-3">
              ...
              <CardTitle className="text-3xl text-gray-900">{profile.stats.winRate.toFixed(1)}%</CardTitle>
            </CardHeader>
          </Card>
        ...
        <Card className="bg-white border-gray-200 shadow-sm">
          <CardHeader>
            <CardTitle className="text-gray-900">Recent Trades</CardTitle>
